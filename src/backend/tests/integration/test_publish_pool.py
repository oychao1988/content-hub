...
class TestPublishPoolEndpoints:
    ...
    def test_add_content_to_pool(self, client: TestClient, admin_auth_headers, test_customer):
        """测试添加内容到发布池"""
        # 创建测试数据
    ...
    def test_get_publish_pool_list(self, client: TestClient, admin_auth_headers, test_customer):
        """测试获取发布池列表"""
        # 创建测试数据
        platform_response = client.post(
            "/api/v1/platforms/",
    ...
    def test_get_publish_pool_item_detail(self, client: TestClient, admin_auth_headers, test_customer):
        """测试获取发布池项详情"""
        # 创建测试数据
        platform_response = client.post(
            "/api/v1/platforms/",
    ...
    def test_update_publish_pool_item(self, client: TestClient, admin_auth_headers, test_customer):
        """测试更新发布池项"""
        # 创建测试数据
        platform_response = client.post(
            "/api/v1/platforms/",
    ...
    def test_delete_from_publish_pool(self, client: TestClient, admin_auth_headers, test_customer):
        """测试从发布池删除"""
        # 创建测试数据
        platform_response = client.post(
            "/api/v1/platforms/",
    ...
    def test_batch_publish_from_pool(self, client: TestClient, admin_auth_headers, test_customer):
        """测试批量发布"""
        # 创建测试数据
        platform_response = client.post(
            "/api/v1/platforms/",
    ...
    def test_filter_by_status(self, client: TestClient, admin_auth_headers, test_customer):
        """测试按状态筛选发布池"""
        # 创建测试数据
        platform_response = client.post(
            "/api/v1/platforms/",
...
class TestPublishPoolWorkflows:
    ...
    def test_priority_adjustment(self, client: TestClient, admin_admin_auth_headers, test_customer):
        """测试调整发布优先级"""
        # 创建测试数据
        platform_response = client.post(
            "/api/v1/platforms/",
            ...
            headers=admin_admin_auth_headers
        )
    ...
    def test_publish_status_transitions(self, client: TestClient, admin_admin_auth_headers, test_customer):
        """测试发布状态流转"""
        # 创建测试数据
        platform_response = client.post(
            "/api/v1/platforms/",
    ...
    def test_publish_retry_mechanism(self, client: TestClient, admin_admin_auth_headers, test_customer):
        """测试发布重试机制"""
        # 创建测试数据
        platform_response = client.post(
            "/api/v1/platforms/",
    ...
    def test_get_pending_entries(self, client: TestClient, admin_admin_auth_headers, test_customer):
        """测试获取待发布条目"""
        # 创建测试数据
        platform_response = client.post(
            "/api/v1/platforms/",
        ...
        # 获取待发布条目
        pending_response = client.get("/api/v1/publish-pool/pending", headers=admin_admin_auth_headers)
    ...
    def test_get_pool_statistics(self, client: TestClient, admin_admin_auth_headers):
        """测试获取发布池统计信息"""
        stats_response = client.get("/api/v1/publish-pool/stats", headers=admin_admin_auth_headers)
    ...
    def test_pool_entry_response_format(self, client: TestClient, admin_admin_auth_headers, test_customer):
        """测试发布池条目响应格式"""
        # 创建测试数据
        platform_response = client.post(
            "/api/v1/platforms/",
        ...
        # 获取详情验证格式
        detail_response = client.get(f"/api/v1/publish-pool/{pool_id}", headers=admin_admin_auth_headers)
    ...
    def test_scheduled_publishing(self, client: TestClient, admin_admin_auth_headers, test_customer):
        """测试定时发布"""
        # 创建测试数据
        platform_response = client.post(
            "/api/v1/platforms/",
